...
/**
 * useMegaLeadForm — AvaDent Digital Dental Solutions LP form submission hook.
 * Reference: landing-page-forms skill + repower-landing + forwardit-landing.
 *
 * SITE_ID is a placeholder until Mega Admin registration completes
 * (landing-page-deploy skill Stage 2). Customer ID is real from Atlas task
 * 84f0fa5d-81b7-49d4-9d31-848e18823287.
 */
  ...
  const submit = useCallback(
    async (
      ...
      const payload: SubmissionPayload = {
        ...
        source_provider: options.sourceProvider ?? "avadent-landing",
        form_data: formData,
